...
show_menu() {
    ...
    echo "============================================="
    echo ""
    echo "BACKEND СЕРВЕР (159.89.108.100):"
    ...
    echo ""
    echo "FRONTEND СЕРВЕР (139.59.158.109):"
...
show_docs() {
    ...
    if [ -f "FULL_DEPLOYMENT_GUIDE.md" ]; then
        ...
        echo "- Backend API: https://159.89.108.100:8000/docs"
        echo "- Health Check Backend: https://159.89.108.100:8000/health"
